...
type {{$stName}}Dal interface {
    ...
    Get(ctx context.Context, id int64) (*{{$mdName}}, error)
    GetByFilter(ctx context.Context, q *{{$queryPrefix}}Get{{$stName}}ByFilter) (*{{$mdName}}, error) 
    ExistByFilter(ctx context.Context, q *{{$queryPrefix}}Exist{{$stName}}ByFilter) (bool, error) 
...
func (b {{$stName}}) Get(ctx context.Context, id int64) (*{{$mdName}}, error) {
    var row {{$mdName}}
...
func (b {{$stName}}) GetByFilter(ctx context.Context, q *{{$queryPrefix}}Get{{$stName}}ByFilter) (*{{$mdName}}, error) {
    var row {{$mdName}}
...
func (b {{$stName}}) ExistByFilter(ctx context.Context, q *{{$queryPrefix}}Exist{{$stName}}ByFilter) (existed bool, err error) {
    err = b.db.Model(&{{$mdName}}{}).
            Select("1").
            Scopes(func(db *gorm.DB) *gorm.DB {
        {{- range $f := $e.Fields}}
